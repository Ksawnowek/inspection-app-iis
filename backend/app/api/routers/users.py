...
from app.dependencies import get_current_user_from_cookie, get_user_service
...
def patch_user(uzt_id: int, update_dto: UzytkownikUpdateDTO, service: UserService = Depends(get_user_service)):
    try:
